...
public class AddToOrderAction implements Action {
    ...
    public ActionResult execute(HttpServletRequest request, HttpServletResponse response) throws ActionException {
        ...
        if (user != null) {
            ...
            createOrder(order, user, finalPrice, session, currentFood);
            try {
    ...
    private Integer createOrder(Order order, User user, Integer finalPrice, HttpSession session, Food currentFood) throws ActionException {
        if (order == null) {
            order = new Order();
