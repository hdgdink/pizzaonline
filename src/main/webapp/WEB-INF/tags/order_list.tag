...
<div id="order" class="section">
    ...
    <div>
        <table class="table">
            <tr>
                ...
                <td><fmt:message key="default.size"/></td>
    ...
    <c:choose>
        <c:when test="${order.sumOfOrder==0 || order.sumOfOrder==null}">
            <a href="#error_form" title="Add to order" class="btn btn-primary">
                <fmt:message key="default.checkout"/></a>
        </c:when>
        <c:otherwise>
    ...
    <div class="popup">
        <h2><fmt:message key="default.listIsEmpty"/></h2>
    ...
    <div class="popup">
        <form action="chekout_order" method="post">
            <h4><fmt:message key="default.address"/></h4>
            <hr>
            <h6><fmt:message key="default.yourAddress"/></h6>
