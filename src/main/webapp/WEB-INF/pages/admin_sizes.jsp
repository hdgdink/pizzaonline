          ...
          <div class="caption">
            ...
            <table class="table">
              ...
              <c:forEach items="${allSizesAdmin}" var="size">
                <form id="edit_sizes" method="POST" action="edit_size">
                  <tr>
                    <input type="hidden" value="${size.id}" name="id"/>

                    <td>${size.id}</td>
                    <td>
                      <input type="number" class="form-control" name="size" value="${size.size}" required min="1"/>
                    </td>
                  ...
                  <div class="input-group">
                    <div class="col-lg-12">
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="value_u" name="size" value="" placeholder="..." min="1" required>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                      <div class="input-group">
                        <span class="input-group-addon">
                          <fmt:message key="default.sizeCaption"/>
                        </span>
                        <input type="text" class="form-control" id="name_u" name="name" value="" placeholder="..." required>
                      </div>
                    </div>
