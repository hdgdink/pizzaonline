...
<fmt:bundle basename="i18n.text">
    ...
    <div id="main">
        ...
        <div class="section">
            ...
            <div class="caption">
                <h2><fmt:message key="default.editOrders"/></h2>
                ...
                <table class="table">
                    ...
                    <c:forEach items="${orderList}" var="order">
                        <form id="edit_order" method="POST" action="edit_order">
                            <tr>
                                <input type="hidden" value="${order.id}" name="id"/>
                                <td>${order.id}</td>
                                <td>
                                    <input type="number" class="form-control" name="userId" value="${order.userId}"
                                           required readonly="readonly"/>
                                </td>
                                <td>
                                    <input type="number" class="form-control" name="sumOfOrder"
                                           value="${order.sumOfOrder}"
                                           required min="1" readonly="readonly"/>
                                </td>
                                <td>
                ...
                <form id="create_order" method="POST" action="create_order">
                    <div class="input-group">
                        <div class="col-lg-12">
                            <div class="input-group">
                                <span class="input-group-addon"><fmt:message key="default.userId"/></span>
                                <input type="number" class="form-control" id="userId_u" name="userId"
                        ...
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="sumOfOrder_u" name="sumOfOrder"
                                       value="" placeholder="..." required min="1">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="input-group">
                        ...
                        <div class="col-lg-12">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="phone_u" name="phone"
                                       value="" placeholder="..." required>
                            </div>
                        </div>
                        <div class="col-lg-12">
